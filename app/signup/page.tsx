      ...
      if (err instanceof Error) {
        ...
        switch (errorCode) {
          ...
          case "auth/weak-password":
            setError("Weak password (min 6 characters)");
            break;
          default:
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  ...
                  <Link href="/signin" className="font-medium text-purple-600 hover:text-purple-700 hover:underline">
                    Sign in
                  </Link>
                </p>
              </CardFooter>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-purple-600 via-blue-600 to-pink-600 items-center justify-center p-8">
        <div className="max-w-md text-white space-y-6">
          ...
          <p className="text-xl opacity-90">
            Join thousands of ML engineers who are shipping custom models faster than ever.
          </p>
